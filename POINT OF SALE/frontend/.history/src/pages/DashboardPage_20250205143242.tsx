  ...
  return (
    <div className="flex-grow flex flex-row p-6 bg-white dark:bg-gray-900 overflow-hidden">
      ...
      <div className="w-[40%] pl-4">
        <h2 className="text-xl font-semibold text-black dark:text-gray-100 mb-4">Cart Items</h2>
        ...
        <div className="mt-4 ">
          <p><span className="bolder text-black text-lg">Subtotal :</span> ${subtotal.toFixed(2)}</p>
          <p>Tax (10%): ${tax.toFixed(2)}</p>
          <p>Total: ${total.toFixed(2)}</p>
          <button className="mt-4 px-6 py-2 bg-blue-500 text-white rounded-lg">Proceed to Pay</button>
        </div>
      </div>
    </div>
  );
