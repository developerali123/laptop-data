  ...
  return (
    <div className="flex-grow flex flex-row p-6 bg-white dark:bg-gray-900 overflow-hidden">
      ...
      <div className="w-[60%]">
        ...
        <div
  className="w-full h-[80vh] overflow-y-auto p-4 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg scrollbar-thin scrollbar-thumb-rounded-lg scrollbar-track-gray-200 scr dark:scrollbar-track-gray-700 scrollbar-thumb-gray-500 dark:scrollbar-thumb-blue-700"
>
