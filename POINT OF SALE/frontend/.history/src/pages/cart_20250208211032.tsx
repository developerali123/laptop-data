...
import { FaShoppingCart,FaPause, FaTrashAlt } from "react-icons/fa";

const Cart = ({ cartItems, FaPercentage,FaTag,deleteCartItem, subtotal, tax, total, discount, appliedCoupons }) => {
  return (
