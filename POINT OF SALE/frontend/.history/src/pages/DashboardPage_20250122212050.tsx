    ...
    <>
      ...
      <div className="flex-grow flex flex-row p-6 bg-white dark:bg-gray-900 overflow-hidden">
        ...
        <div className="w-[60%]">
          ...
          <div
            className="w-full h-[80vh]  <style>
        {`
          .scrollbar-custom {
            scrollbar-width: thin; /* For Firefox: thin scrollbar */
            scrollbar-color: #6b7280 #e5e7eb; /* Thumb and track colors */
          }
        ...
        `}
      </style> overflow-y-auto p-4 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg scrollbar-custom"
          >
