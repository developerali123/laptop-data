...
import { FaShoppingCart,FaPercentage,FaPause, FaTrashAlt } from "react-icons/fa";

const Cart = ({ cartItems ,FaTag,deleteCartItem, subtotal, tax, total, discount, appliedCoupons }) => {
  return (
