...
const DashboardPage = () => {
  ...
  const products = [
    ...
    { id: 6, name: "mashed Potato", price: 50, category: "Chinese", stock: 473, image: "/images/shirt.jpg" },

    { id: 7, name: "italian pizza", price: 50, category: "Chinese", stock: 473, image: "/images/shirt.jpg" },
