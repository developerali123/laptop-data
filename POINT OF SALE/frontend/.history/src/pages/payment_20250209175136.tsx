...
export default function PaymentPage({ 
  ...
  useEffect(() => {
    ...
    const calculatedTotal = subtotal * 1.1; // Including 10% tax
    ...
    <div className="grid grid-cols-[auto,1fr] h-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 p-8">
        ...
        <div className="grid grid-cols-4 gap-2 mt-4 text-center">
          {[1, 2, 3, "clear", 4, 5, 6, "←", 7, 8, 9, 0].map((key) => (
            <button key={key} className="p-3 bg-gray-200 rounded" onClick={() => handleKeypadClick(key)}>
              {key}
            </button>
          ))}
        </div>
      ...
      <div className="w-[500px] min-w-[350px] h-full bg-gray-100 border-l flex flex-col p-8">
