...
export default function PaymentPage({ 
  ...
  <div className="flex-1 overflow-y-auto"> {/* Ensure the cart content is scrollable if it overflows */}
    <Cart 
      cartItems={cartItems} 
  ...
  {/* Optional: Add a footer or summary section for the cart */}
  {/* <div className="mt-4 p-4 bg-white rounded shadow">
    <p className="text-lg font-bold">Cart Summary</p>
    <p>Total Items: {cartItems.length}</p>
    <p>Total Amount: ${totalDue.toFixed(2)}</p>
  </div> */}
</div>
