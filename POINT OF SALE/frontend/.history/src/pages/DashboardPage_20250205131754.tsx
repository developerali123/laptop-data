...
import { useState } from "react";
import { FaShoppingCart, FaSyncAlt, FaPause, FaTag, FaPercentage } from "react-icons/fa";
    ...
    <>
      ...
      <div className="flex-grow flex flex-row p-6 bg-white dark:bg-gray-900 overflow-hidden">
        ...
        <div className="w-[60%]">
          ...
          <div
            className="w-full h-[80vh] snap-y overflow-y-auto p-4 bg-gray-50 dark:bg-gray-900 rounded-lg scrollbar:rounded-lg shadow-lg  scrollbar-custom"
          >
        ...
        <div className="w-[40%] pl-4 flex flex-col h-full overflow-hidden">
          ...
          < className="p-4 bg-white shadow-lg rounded-lg w-full max-w-md mx-auto">
